...
function PopupCard({popupClicked,popupImg,handleCloseClick}) {
  ...
  return (
    <div className='relative smooth-transition transition overflow-hidden ' onLoad={()=> document.body.style.overflow='hidden'} >

        
        {popupClicked && popupImg && 
          <div onLoad={()=> document.body.style.overflow='visible'} className=' flex flex-col fixed h-screen w-screen fixed bg-gradient-to-b 
          from-slate-900  to-slate-900 scale-200 top-0  z-5 bg-fixed   '>
             <div className='flex-1 relative w-4/5 max-w-max md:w-max lg:w-max h-40 scale-110 mx-auto my-28 relative '>
